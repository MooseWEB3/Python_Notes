...
| Topic | Guide |
|---|---|
| Python fundamentals | [Open guide](python_fundamentals_en.html) |
...
| Advanced Python | [Open guide](python_advanced_en.html) |
...
- Python installation, syntax, built-in types, collections, control flow, functions, exceptions, files, classes, type hints, testing, and a complete beginner project;
...
- Python's data model, iterators, generators, decorators, context managers, descriptors, generics, threads, processes, asyncio, profiling, security, and production architecture;
...
| Sujet | Guide |
|---|---|
| Fondamentaux de Python | [Ouvrir le guide](python_fundamentals_en.html) |
...
| Python avancé | [Ouvrir le guide](python_advanced_en.html) |
...
- Installation de Python, syntaxe, types intégrés, collections, contrôle de flux, fonctions, exceptions, fichiers, classes, annotations de type, tests et projet complet pour débutants ;
...
- Modèle de données Python, itérateurs, générateurs, décorateurs, gestionnaires de contexte, descripteurs, génériques, threads, processus, asyncio, profilage, sécurité et architecture de production ;
...
| Tema | Guia |
|---|---|
| Fundamentos de Python | [Abrir o guia](python_fundamentals_en.html) |
...
| Python avançado | [Abrir o guia](python_advanced_en.html) |
...
- Instalação do Python, sintaxe, tipos integrados, coleções, fluxo de controle, funções, exceções, arquivos, classes, dicas de tipo, testes e um projeto completo para iniciantes;
...
- Modelo de dados do Python, iteradores, geradores, decoradores, gerenciadores de contexto, descritores, genéricos, threads, processos, asyncio, criação de perfis, segurança e arquitetura de produção;
